...
class DatabaseConnection:
    def __init__(self):
        self._CONNECTION_URL = "mongodb://{}:{}@{}/?authMechanism=DEFAULT&authSource={}&retryWrites=false".format(
            DOCUMENT_DB_USER, DOCUMENT_DB_PASSWORD, DOCUMENT_DB_URL, DEFAULT_DATABASE
        )
        try:
